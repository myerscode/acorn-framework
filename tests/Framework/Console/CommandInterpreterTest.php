...
class CommandInterpreterTest extends BaseTestCase
{
    ...
    public function testBasicParameterParsing()
    {
        ...
        $results = $this->parser()->parse('command:name {argument} {--option}');
        ...
        $results = $this->parser()->parse('command:name {argument?* : The argument description.}    {--option=* : The option description.}');
    ...
    public function testShortcutNameParsing()
    {
        ...
        $results = $this->parser()->parse('command:name {--o|option=* : The option description.}');
    ...
    public function testDefaultValueParsing()
    {
        ...
        $results = $this->parser()->parse('command:name {argument=*defaultArgumentValue1,defaultArgumentValue2} {--option=*defaultOptionValue1,defaultOptionValue2}');
    ...
    public function testArgumentDefaultValue()
    {
        ...
        $results = $this->parser()->parse('command:name {argument=default : The argument description.}');
    ...
    public function testOptionDefaultValue()
    {
        ...
        $results = $this->parser()->parse('command:name {--option=default : The option description.}');
